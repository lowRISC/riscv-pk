...
#define CSR_STAGCTRL_SCRATCH 0x9e0
...
#define CSR_MTAGCTRL_SCRATCH 0xbe0
...
DECLARE_CSR(stagctrl_scratch, CSR_STAGCTRL_SCRATCH)
...
DECLARE_CSR(mtagctrl_scratch, CSR_MTAGCTRL_SCRATCH)
